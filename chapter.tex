...
employed in human-robot interaction.
...
3D representation and planning platform, Move3D \cite{Simeon2001}, which also
...
At the core, ORO is build around the OpenJena ontology management library,
...
knowledge base are the most common approach in the litterature, other, more
