...
We start by introducing the general approach applied to the symbolic model of
the environment alone. We introduce as well \emph{search} and
\emph{exploration} policies.
...
We also introduce a geometric approch for the analysis of the
...
Spatial reasoning~\cite{O'Keefe1999} has been used
